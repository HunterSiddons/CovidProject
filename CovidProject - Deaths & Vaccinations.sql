...
-- Does not separate between first, second, or third shot. Only designates if someone received a vaccination.
...
-- Using Temp Tables to perform calculation from previous query
